    ...
    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-6">
      <div className="flex items-center space-x-4">
        ...
        >
          ...
          <span className="hidden sm:inline">{t('backToApprovals')}</span>
        </button>
        <div>
    ...
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6">
      <div className="bg-white p-3 sm:p-4 rounded-lg border border-gray-200 shadow-sm">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-xs sm:text-sm text-gray-500">{t('totalWorkflows')}</p>
      ...
      <div className="bg-white p-3 sm:p-4 rounded-lg border border-gray-200 shadow-sm">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-xs sm:text-sm text-gray-500">{t('completionRate')}</p>
  ...
  const LoadingState = () => (
    <div className="flex items-center justify-center min-h-96">
      <div className="text-center">
        ...
        <div className="text-lg text-gray-600">{t('loadingWorkflowBuilder')}</div>
        <p className="text-sm text-gray-500 mt-2">{t('loadingWorkflowBuilderDescription')}</p>
      </div>
    </div>
  );
  ...
  const MainContent = () => (
    <div className="space-y-6">
      ...
      <div className="lg:hidden bg-gray-50 rounded-lg p-4 border border-gray-200">
        <h3 className="font-semibold text-gray-800 mb-2">{t('needHelp')}</h3>
        <p className="text-sm text-gray-600 mb-3">
          {t('workflowBuilderOptimizedForDesktop')}
        </p>
