...
import ProjectExperienceTable from "../../../vendor-dashboard/components/ProjectExperienceTable.js";
...
const DocumentRow = ({ doc, onChange, file, expiryDate, docNumber }) => {
    ...
    <div key={doc.dbKey} className={`grid grid-cols-12 gap-4 items-end p-4 rounded-lg transition duration-150 ${doc.isMandatory ? 'bg-white border border-red-100' : 'bg-gray-50'}`}>
      ...
      <div className="col-span-12 md:col-span-4 flex flex-col justify-end">
        ...
        <p className="text-xs text-gray-500">
          Status: {file ? `Uploaded: ${file.name}` : "Missing"} 
...
// ====================================================================
export default function VendorQualificationForm() {
