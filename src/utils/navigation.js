  ...
  switch (roleId) {
    ...
    case ROLES.VENDOR:
      return [
        ...
        { name: 'My Submittals', translationKey: 'mySubmittals', href: '/vendor-dashboard/submittals', icon: <FileText size={18} /> },
        { name: 'Shop Drawings', translationKey: 'shopDrawings', href: '/vendor-dashboard/drawings', icon: <Grid size={18} /> },
        { name: 'My Deliveries', translationKey: 'myDeliveries', href: '/vendor-dashboard/deliveries', icon: <Truck size={18} /> },
        ...
        { name: 'Notifications', translationKey: 'notifications', href: '/dashboard/notifications', icon: <Bell size={18} /> },
      ];
